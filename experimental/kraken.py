...
def auth():
    key = 'VD50TlUCL5ilXXf5i2SonngI7pnSpG5gX5x+mD/bm3Rx9sMH9PaNzz7/'
    secret = 'TJLVzsoOAo1VrMG3dxewrKa+VyWCCn7lqEAe8MBcRxY+rsbyB6mvC8nsoQYGf8CbHfK6Q7jcmSxDo4kdLu+Cuw=='
    return key, secret
...
class Kraken(Math):
    ...
    def __init__(self, tickers=['XBT/USD']):
    ...
    def Balance(self):
        ...
        # print(self.signature(endpoint, msg))
...
# # while True:
# #     # prices = kraken.store_prices
# #     # size_of_prices = [f'{i}: {len(j)}' for i,j in prices.items()]
# #     # print('Moving Averages:',kraken.MovingAverage(), '\tSize of Prices:', size_of_prices)
...
# #             if lower_ma < higher_ma and last_price > lower_ma and last_price < higher_ma and trade[ticker] == 'neutral':
...
#             higher_ma = ma_2[ticker]
#             last_price = kraken.store_prices[ticker][-1]
#             print(ticker, last_price, len(kraken.store_prices[ticker]))
...
# datafeed.join()
# # print(Kraken().MarketSell("XBTUSD", 5))